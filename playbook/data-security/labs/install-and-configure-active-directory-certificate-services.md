...
Logged in as a domain user and requested a User certificate through the Certificates MMC snap-in.
...
Located the issued certificate within the Certification Authority console and revoked it using the **Key Compromise** revocation reason.
...
- The certificate appeared under **Revoked Certificates**.
...
Exported the Certificate Services registry configuration to a `.reg` file.
